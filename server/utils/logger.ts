...
export class Logger {
    ...
    private context: string = 'server'
    private contextAttributes: LogAttributes = {}
    ...
    setContextAttributes(attrs: LogAttributes): void {
    ...
    log(level: LogLevel, msg: string, attrs: LogAttributes = {}): void {
        ...
        const mergedAttrs = { ...this.contextAttributes, ...attrs }
