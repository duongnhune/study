...
const translations = {
  en: {
    ...
    __activeColor: "Active Day Background Color",
    __activeTextColor: "Active Day Text Color",
  ...
  vi: {
    ...
    __activeColor: "Màu nền ngày đang chọn",
    __activeTextColor: "Màu văn bản ngày đang chọn",
...
const Agenda: WidgetType = {
  ...
  props: [
    ...
    {
      key: "activeDayColor",
      name: "__activeDayColor",
      inputType: WidgetPropInput.Color,
      category: WidgetPropCategory.Style,
      required: false
    },
    {
      key: "activeDayTextColor",
      name: "__activeDayTextColor",
      inputType: WidgetPropInput.Color,
      category: WidgetPropCategory.Style,
      required: false
    },
