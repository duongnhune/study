...
const Header: WidgetType = {
  ...
  defaultProps: JSON.stringify({
    logoPrimary: 'https://breezing-upload.s3.ap-southeast-1.amazonaws.com/site/baynanza/logo-baynanza-white.svg',
    logoSecondary: 'https://breezing-upload.s3.ap-southeast-1.amazonaws.com/site/baynanza/logo-baynanza-white.svg',
    menuItems: [
      { text: 'Home', link: '#' },
      { text: 'Events', link: '#' },
      { text: 'Bazaar', link: '#' },
