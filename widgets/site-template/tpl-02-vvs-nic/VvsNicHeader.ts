...
const VvsNicHeader: WidgetType = {
  ...
  defaultProps: JSON.stringify({
    logoPrimary: 'https://breezing-upload.s3.ap-southeast-1.amazonaws.com/site/vvs-nic/logo-nic.png',
    logoSecondary: 'https://breezing-upload.s3.ap-southeast-1.amazonaws.com/site/vvs-nic/logo-nic-white.svg',
    menuItems: [
      { text: 'Overview', link: '#' },
      { text: 'Speakers', link: '#' },
      { text: 'Agenda', link: '#' },
      { text: 'Previous events', link: '#' }
    ]
  }),
  translations: translations,
};

export default VvsNicHeader;